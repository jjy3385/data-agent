...
* [x] FastAPI 프로젝트 기본 구조
  * Feature: [FEAT-0001 FastAPI Bootstrap Spec](../features/0001-fastapi-bootstrap/spec.md)

* [x] Admin DB Foundation
  * Feature: [FEAT-0002 Admin DB Foundation Spec](../features/0002-admin-db-foundation/spec.md)
  * 사용자·역할·Table Policy·Audit을 위한 SQLite 기반 Admin DB 구성

* [ ] FEAT-0003 MCP Read-Only Data Access
  * AdventureWorks2022 전용 Read-Only MCP 연결
  * Schema Inspection과 Physical Metadata 구성
  * 제한된 Read-Only Query 실행

* [ ] FEAT-0004 Natural Language Query Walking Skeleton
